...
public class SetCompanyHome {
    ...
    public SetCompany findById( java.lang.String id) {
        ...
        try {
            SetCompany instance = (SetCompany) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.SetCompany", id);
            if (instance==null) {
    ...
    public List<SetCompany> findByExample(SetCompany instance) {
        ...
        try {
            List<SetCompany> results = (List<SetCompany>) sessionFactory.getCurrentSession()
